...
describe("Circle", () => {
    it('should return a circle logo, color choice, and text color', ()=>{
        ...
        const color = shape.shapeColor("gray")
        const expected =  `<circle cx="150" cy="100" r="100" fill="gray" />`
...
describe('Triangle', () => {
    it('should return a Triangle logo, color choice, text, and text color', () => {
        ...
        const color = shape.shapeColor("plum")
...
describe('Square', () => {
    it('should return a Square logo, color choice, text, and text color', () => {
        ...
        const color = shape.shapeColor("blue")
